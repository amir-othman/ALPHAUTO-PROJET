                                ...
                                <ul>
                                    ...
                                    <li class="sub-items">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="active"><a href="listcarstosell.php" title="Car Detail">Acheter une voiture</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="banner-content">
                        <h1 class="h1-title wow fadeup-animation" data-wow-duration="0.8s">Nos voitures à vendre</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4">
                    <div class="cars-sidebar">
                        <div class="cars-sidebar-box wow right-animation" data-wow-duration="0.8s" data-wow-delay="0.3s">
                            <h3 class="h3-title">Catégorie</h3>
                            <ul>
                        <?php 
                            $allz = $admincrudpanel->getalllist();  
                            foreach ($allz as $row) {
                                echo('<li><a href="#">'.$row["lista"].'</a></li>');
                            }
                        ?>
                            </ul>
                        </div>
                        <?php 
                            $brandz = $admincrudpanel->getAllitems(); 
                            $getAll =$brandz->rowCount();
                        ?>


                        <div class="cars-sidebar-box wow right-animation" data-wow-duration="0.8s" data-wow-delay="0.3s">
                            <h3 class="h3-title">Marque de voitures</h3>
                            <ul>
                                <li><a href="#" title="All Cars">Toutes les voitures <span><?php echo($getAll);?></span></a></li>
                        <?php 
$exist = array();
$admincrudpanel = new admincrudpanel();
...
foreach ($liste as $row) {
    ...
    if(!in_array($maq, $exist)){
        ...
        $modd = $admincrudpanel->count4mef($maq); 
        echo('<li><a href="javascript:void(0);">'.$row['marque'].'<span>'.$modd.'</span></a></li>'); 
    }
}
?>
                            </ul>
                ...
                <div class="col-lg-8">
                    <div class="cars-list">
                        <div class="row">
                            <?php
                                $allpiece = $admincrudpanel->Allproductssell($_GET['id']);
                                    ...
                                    <div class="car-box-text">
                                        ...
                                        <div class="cars-features-list">
                                            ...
                                            <div class="cars-features-box">
                                                ...
                                                <p><?php echo($singlepiece['carburant']);?></p>
                                            </div>

                                        </div>
                                        <div class="cars-features-btn">

                                            <a href="buydetails.php?id_vehicule=<?php echo($singlepiece['idVehicule']);?>" class="sec-btn" title="Ajouter Au Panier"><span>obtenir plus de détails</span></a>
                                ...
                                <ul>
                                    <?php
                                        if($_GET['id']==1){
                                            ...
                                            echo('<li><a href="listcarstosell.php?id='.$previ.'" class="arrow" title="Previous"><i class="fas fa-angle-double-left" aria-hidden="true"></i></a></li>');
                                        }
                                        $totalPages=$admincrudpanel->Allcarssell();
                                        for($i=1; $i <= $totalPages; $i++){
                                            if($_GET['id']==$i){
                                                echo('<li class="active"><a href="listcarstosell.php?id='.$i.'">'.$i.'</a></li>');
                                            }else{
                                                echo('<li><a href="listcarstosell.php?id='.$i.'">'.$i.'</a></li>');
                                            }
                                        }
                                        if($_GET['id']==$totalPages){
                                            ...
                                            echo('<li><a href="listcarstosell.php?id='.$next.'" class="arrow" title="Next"><i class="fas fa-angle-double-right" aria-hidden="true"></i></a></li>');
                                        }
                                    ?>
                                </ul>
                            </div>
