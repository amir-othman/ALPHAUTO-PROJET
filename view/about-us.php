...
if(isset($_GET['cameforpanier'])){
    $wrong='Vous devez vous connecter pour voir votre panier ..';
}
...
<div class="main">
                        ...
                        <nav class="main-navigation">
                            ...
                            <div class="mobile-menu-box">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="about-us.php" title="About Us">À propos de nous</a></li>
                                    <li class="sub-items">
    ...
    <!-- Banner Start -->
    <section class="main-banner inner-banner back-img" style="background-image: url('assets/images/about-banner.jpeg');">
        <span class="shape"><img src="assets/images/inner-banner-shape.svg" alt="shape"></span>
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="banner-content">
                        <h1 class="h1-title wow fadeup-animation" data-wow-duration="0.8s">À propos de nous</h1>
                    </div>
                </div>
            </div>
        </div>
        <div class="main-breadcrumb">
            <div class="breadcrumb-box wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                <p><a href="index.php" title="Home">Acceuil</a></p>
                ...
                <div class="col-lg-6 order-lg-1 order-2">
                    <div class="about-content wow right-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="title left">
                            <h2 class="h2-title">Qui sommes nous<span> ?</span></h2>
                            <span class="title-line"></span>
                        </div>
                        <div class="about-text">
                            <p><b>Alpha Team</b> est une jeune équipe composée de 6 personnes devouées:<br><a href="https://github.com/youssefgr">Youssef Grissa</a>, <a href="https://github.com/amir-othman">Amir othman</a>, <a href="https://github.com/mou7eeeb">Mouheb sayadi</a>, <a href="https://github.com/Fayed30">Med fayed jaidi</a>, <a href="https://github.com/BehaDev">Beha Eddine Jaouadi</a>, <a href="https://github.com/bmmarouen">Maouen Ben Mohamed</a>.</p>
                        </div>
                    </div>
                    ...
                    <div class="about-content wow right-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="title left">
                            <h2 class="h2-title">Pourquoi avoir créer <span><?php echo($sitename);?></span> ?</h2>
                            <span class="title-line"></span>
                        </div>
                        <div class="about-text"><p>Nous avons remarqué que la plupart des sites de voitures ne propsaient pas beaucoup de services et se contentaient soit de <b>louer</b>, <b>acheter</b>, ou de <b>vendre</b> des voitures.<br>C'est pour cette raison que nous avons penser a vous chers clients.<br>Notre site offre toutes ces possibilités avec une option d'achat de pieces de rechanges</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 order-lg-2 order-1">
                    <div class="about-img-box">
                        <div class="about-img back-img wow left-animation" data-wow-duration="0.8s" data-wow-delay="0.2s" style="background-image: url('assets/images/about-us-img.jpg');"></div>
                        <img src="assets/images/about-car1.png" width="570" height="534" class="wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.3s" alt="About Car">
                    </div>
                </div>
            </div>
        </div>
