...
$list = [];
if(isset($_SESSION['smartCookies'])){
    $myid=$admincrudpanel->getIDUser($_SESSION['smartCookies']);
    $list = $admincrudpanel->getAllPanierWithFacture($myid);
}else{
...
<head>
    ...
    <!-- Google Fonts -->
    <link
        href="https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&family=Oxanium:wght@200;300;400;500;600;700;800&display=swap"
        rel="stylesheet">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="banner-content">
                            <h1 class="h1-title wow fadeup-animation" data-wow-duration="0.8s">Historique des commandes</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="title wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                            <h2 class="h2-title">Historique des commandes</h2>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped" id="myTable" >
                                ...
                                <?php foreach ($list as $item): ?>
                                    <?php if( count($admincrudpanel->getPanierProductById( $item->id)) != 0) : ?>
                             <tr>
                             <th><?= $item->id; ?></th>
                                        <th><?= $item->date_creation; ?></th>
                                        <th><?php if($item->paye==1){echo 'payé';}else{echo 'non payé';} ?></th>
                                        <th>
                                        <?php if($item->paye==1) : ?>
                                        <a href="facture.php?id_facture=<?= $item->id_facture; ?>">Consulter</a>
                                                <?php else : ?>
