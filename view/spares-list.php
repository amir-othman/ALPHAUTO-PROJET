                                ...
                                <ul>
                                    ...
                                    <li class="sub-items">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="active"><a href="spares-list.php" title="Piece de rechange">Piece de rechange</a></li>
                                        </ul>
                                    </li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="banner-content">
                        <h1 class="h1-title wow fadeup-animation" data-wow-duration="0.8s">Piece de rechange</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="cars-sidebar">
                        <div class="cars-sidebar-box wow right-animation" data-wow-duration="0.8s" data-wow-delay="0.3s">
                            <h3 class="h3-title">Liste des Pièces</h3>
                            <ul>
                        <?php 
                            $exist = array();
                            $liste = $admincrudpanel->getListcategoriepiece();
                            foreach ($liste as $Cat) {
                                foreach ($liste as $row) {
                                    $maq = $row['idCategory'];
                                    $mow = $row['nom_cat'];
                                    if (!in_array($maq, $exist)) {
                                        array_push($exist, $maq);
                                        $modd = $admincrudpanel->count4me($maq);
                        ?>
                            <li><a href="javascript:void(0);" title="Aston Martin"><?php echo($row['nom_cat']);?> <span><?php echo($modd);?></span></a></li>
                        <?php
                                    }
                                }
                            }
                ...
                <div class="col-lg-8">
                    <div class="cars-list">
                        <div class="row">
                            <?php
                                $allpiece = $admincrudpanel->Allpiecesell($_GET['id']);
                                foreach ($allpiece as $singlepiece) {
                            ?>
                            <div class="col-md-6">
                                <div class="car-box wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                                    <div class="car-img">
                                        <img src="<?php echo $singlepiece['img']; ?>" width="430" height="220" alt="Aston Martin DBS">
                                    </div>
                                    <div class="car-box-text">
                                        <h3 class="h3-title"><?php echo $singlepiece['nompiece']; ?></h3>
                                        <div class="price-reviews">
                                            <div class="car-price">
                                                <h4 class="h4-title"><span>TND <?php echo $singlepiece['prixpiece']; ?></h4>
                                            </div>
                                        </div>
                                        <div class="cars-features-list" style="margin-right: -91px;">
                                            <div class="cars-features-box">
                                                <span class="icon"><img src="assets/images/poids.png" width="45" height="45" alt="AC"></span>
                                                <p><?php echo $singlepiece['poidspiece']; ?></p>
                                            </div>
                                            <div class="cars-features-box">
                                                <span class="icon"><img src="assets/images/recycle.png" width="30" height="45" alt="Auto"></span>
                                                <p><?php echo $singlepiece['etatp']; ?></p>
                                            </div>
                                            <div class="cars-features-box">
                                                <span class="icon"><img src="assets/images/country.png" width="45" height="45" alt="Petrol"></span>
                                                <p><?php echo $singlepiece['pays']; ?></p>
                                            </div>
                                        </div>
                                        <div class="cars-features-btn">
                                            <a href="panier.php?id_piece=<?php echo($singlepiece['idp']);?>" class="sec-btn" title="Ajouter Au Panier"><span>Ajouter Au Panier</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="pagination wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                                <ul>
                                    <?php
                                        if($_GET['id']==1){
                                            echo('<li></li>');
                                        }else{
                                            $previ=intval($_GET['id'])-1;
                                            echo('<li><a href="spares-list.php?id='.$previ.'" class="arrow" title="Previous"><i class="fas fa-angle-double-left" aria-hidden="true"></i></a></li>');
                                        }
                                        $totalPages=$admincrudpanel->Allpiecesexll();
                                        for($i=1; $i <= $totalPages; $i++){
                                            if($_GET['id']==$i){
                                                echo('<li class="active"><a href="spares-list.php?id='.$i.'">'.$i.'</a></li>');
                                            }else{
                                                echo('<li><a href="spares-list.php?id='.$i.'">'.$i.'</a></li>');
                                            }
                                        }
                                        if($_GET['id']==$totalPages){
                                            echo('<li></li>');
                                        }else{
                                            $next=intval($_GET['id'])+1;
                                            echo('<li><a href="spares-list.php?id='.$next.'" class="arrow" title="Next"><i class="fas fa-angle-double-right" aria-hidden="true"></i></a></li>');
                                        }
                                    ?>
                                </ul>
                            </div>
