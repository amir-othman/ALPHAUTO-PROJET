...
foreach ($liste as $ta3b) {
    ...
    if(isset($_POST['sub'])){
        ...
        if($ch=="DONE"){
            $sajelni='<center><b><font style="color:green;">Merci d\'avoir créé un compte, pour des raisons de sécurité vous devrez vérifier votre email. Nous avons envoyé un e-mail à '.$_POST['email'].', veuillez cliquer sur le lien inclus,<br><br></font></b></center>';
        }else if($ch=="ALREADY"){
...
<div class="main">
    ...
    <section class="main-cars bg">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-8 m-auto">
                    <div class="title wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <h2 class="h2-title">Acheter une <span>voiture</span></h2>
                        <span class="title-line"></span>
                        <p>Notre site vous procure des voitures toutes neuves et d'occasions.<br>Nous vous garantissons un service rapide et sans reproches.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="swiper-slide">
                                    <div class="car-box">
                                        ...
                                        <div class="car-box-text">
                                            ...
                                            <div class="cars-features-btn">
                                            <a href="panier.php?id_vehicule=<?php echo($singlepiece['idVehicule']);?>" class="sec-btn" title="Ajouter Au Panier"><span>Ajouter Au Panier</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <section class="main-our-blog">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="title wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <h2 class="h2-title">Nos derniers <span>blogs</span></h2>
                        <span class="title-line"></span>
                    </div>
                </div>
            </div>
            <div class="blog-list">
                <div class="row">
                        <?php 
                            $liste = $admincrudpanel->Alltthreeblogs();
                    ...
                    <div class="col-lg-4">
                        <div class="blog-box wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.3s">
                            <div class="blog-img back-img" style="background-image: url('<?php echo($img);?>');">
                                <span class="blog-date"><?php echo($row["datep"]);?></span>
                            </div>
                            <div class="blog-text">
                                <?php echo('<h3 class="h3-title"><a href="blog-detail.php?id='.$id.'">'.$row["title"].'</a></h3>');?>
                                <p><?php echo($row["description"]);?></p>
                                <?php echo('<a href="blog-detail.php?id='.$id.'" title="Lire la suite">Lire la suite <i class="fas fa-chevron-right"></i></a>');?>
                            </div>
                        </div>
                    </div>
                        <?php } ?>
