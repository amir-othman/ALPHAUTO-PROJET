            ...
            <div class="row">
                <div class="col-12">
                    <div class="banner-content">
                        <h1 class="h1-title wow fadeup-animation" data-wow-duration="0.8s">Nos voitures à louer</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="cars-list">
                        <div class="row">
                            <?php
                                $allpiece = $admincrudpanel->Allproductslouer($_GET['id']);
                                ...
                                <div class="car-box wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                                    ...
                                    <div class="car-box-text">
                                        ...
                                        <div class="cars-features-btn">
                                            <a href="car-detail.php?id_vehicule=<?php echo($singlepiece['idVehicule']);?>" class="sec-btn" title="Book Now"><span>Reserve maintenant</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <ul>
                                    <?php
                                        if($_GET['id']==1){
                                            ...
                                            echo('<li><a href="listcarstorent.php?id='.$previ.'" class="arrow" title="Previous"><i class="fas fa-angle-double-left" aria-hidden="true"></i></a></li>');
                                        }
                                        $totalPages=$admincrudpanel->Allcarslouer();
                                        for($i=1; $i <= $totalPages; $i++){
                                            if($_GET['id']==$i){
                                                echo('<li class="active"><a href="listcarstorent.php?id='.$i.'">'.$i.'</a></li>');
                                            }else{
                                                echo('<li><a href="listcarstorent.php?id='.$i.'">'.$i.'</a></li>');
                                            }
                                        }
                                        if($_GET['id']==$totalPages){
                                            ...
                                            echo('<li><a href="listcarstorent.php?id='.$next.'" class="arrow" title="Next"><i class="fas fa-angle-double-right" aria-hidden="true"></i></a></li>');
                                        }
                                    ?>
                                </ul>
                            </div>
