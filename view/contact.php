...
foreach ($liste as $ta3b) {
    ...
    if(isset($_POST['submit'])){
        $ch = $admincrudpanel->addfeedback($_POST['firstname'],$_POST['lastname'],$_POST['email'],$_POST['phonenumber'],$_POST['message'],$admincrudpanel->getRealIpAddr());
        if($ch=="DONE"){
            $cbon="Merci de nous avoir contactés 😍 nous vous rappellerons sous peu";
        }
    }
?>
<!DOCTYPE html>
...
<div class="main">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="banner-content">
                        <h1 class="h1-title wow fadeup-animation" data-wow-duration="0.8s">Nous contacter</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="main-contact-detail">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="contact-us-box wow right-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <h2 class="h2-title">Entrer en contact</h2>
                        ...
                        <script>
                            ...
                            <form id="form7" method="post" action="">
                                <div class="row">
                                <?php 
                                    echo('<p><center><font style="color:green;">'.$cbon.'</font></center></p>');

                                ?>
                                <div class="col-lg-6">
                                    <div class="form-box">
                                        <input type="text" class="form-input" id="contact_firstname" name="firstname" placeholder="Prénom">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-box">
                                        <input type="text" class="form-input" id="contact_lastname" name="lastname" placeholder="Last Name (optional)">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-box">
                                        <input type="text" class="form-input" id="contact_email" name="email" placeholder="Adresse e-mail" >
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-box">
                                        <input type="text" class="form-input" id="contact_phone" name="phonenumber" placeholder="Numéro de téléphone" >
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-box mb-0">
                                        <input class="sec-btn" type="button" value="Soumettre" onclick="verificationinfo();">
                                        <button type="submit" name="submit" id="submit" class="sec-btn" style="display:none;"><span>Submit</span></button>
                                    </div>
                                </div>
                            </div>
                            </form>
                                ...
                                <?php 
                                    if(isset($_SESSION['smartCookies'])){
                                        ...
                                        foreach ($details as $tavc3b) {
                                            echo("<script>document.getElementById('contact_firstname').setAttribute('readonly', 'readonly');document.getElementById('contact_lastname').setAttribute('readonly', 'readonly');document.getElementById('contact_email').setAttribute('readonly', 'readonly');document.getElementById('contact_phone').setAttribute('readonly', 'readonly');document.getElementById('contact_firstname').value='".$tavc3b['nom']."';document.getElementById('contact_lastname').value='".$tavc3b['prenom']."';document.getElementById('contact_email').value='".$tavc3b['email']."';document.getElementById('contact_phone').value='".$tavc3b['phonenumber']."';</script>");
                                        }
                                    }
                                ?>
                ...
                <div class="col-lg-4">
                    <div class="page-contact-link">
                        <div class="contact-link-box wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                            <a href="tel:<?php echo($ta3b['phonenumber']);?>" title="Call on <?php echo($ta3b['phonenumber']);?>">
                                <span class="icon"><i class="fas fa-phone-alt" aria-hidden="true"></i></span>
                                Numéro de téléphone
                                <span class="text"><?php echo($ta3b['phonenumber']);?></span>
                            </a>
                        </div>
                        <div class="contact-link-box wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.3s">
                            <a href="mailto:<?php echo($ta3b['email']);?>" title="Mail on <?php echo($ta3b['email']);?>">
                                <span class="icon"><i class="fas fa-envelope" aria-hidden="true"></i></span>
                                Adresse e-mail
                                <span class="text"><?php echo($ta3b['email']);?></span>
                            </a>
                        </div>
                        <div class="contact-link-box wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.4s">
                            <a href="javascript:void(0);" title="<?php echo($ta3b['address']);?>">
                                <span class="icon"><i class="fas fa-map-marker-alt" aria-hidden="true"></i></span>
                                <span class="text"><?php echo($ta3b['address']);?></span>
                            </a>
                        </div>
                        <div class="social-icon wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.5s">
                            <a href="<?php echo($ta3b['fb']);?>" title="Follow on Facebook"><i class="fab fa-facebook-f" aria-hidden="true"></i></a>
                            <a href="<?php echo($ta3b['insta']);?>" title="Follow on Instagram"><i class="fab fa-instagram" aria-hidden="true"></i></a>
                            <a href="<?php echo($ta3b['yt']);?>" title="Follow on Youtube"><i class="fab fa-youtube" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Google Map Start -->
    <div class="main-google-map wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13459.939030229996!2d10.196786381910288!3d36.89433191084954!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12e2cb75abbb1733%3A0x557a99cdf6c13b7b!2sESPRIT%20engineering%20school!5e0!3m2!1sen!2stn!4v1670714794775!5m2!1sen!2stn" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    <!-- Google Map End -->
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#form7").on("keydown", function(event){
                if(event.key == "Enter"){
                    verificationinfo();
                }
                return event.key != "Enter";
