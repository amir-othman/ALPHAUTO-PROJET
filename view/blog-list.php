            ...
            <div class="row">
                <div class="col-12">
                    <div class="banner-content">
                        <h1 class="h1-title wow fadeup-animation" data-wow-duration="0.8s">Notre blog</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="blog-list-box">
                        <div class="row">
                        <?php 
                            $liste = $admincrudpanel->AllproductsPagi($_GET['id']);
                            ...
                            <div class="col-md-6">
                                <div class="blog-box wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                                    ...
                                    <div class="blog-text">
                                        ...
                                        <?php 
                                            echo('<a href="blog-detail.php?id='.$id.'" title="Read More">Lire la suite <i class="fas fa-chevron-right"></i></a>')
                                        ?>
                                    </div>
                                </div>
                            </div>
...
if($_GET['id']==1){
    ...
    echo('<li><a href="blog-list.php?id='.$previ.'" class="arrow" title="Previous"><i class="fas fa-angle-double-left" aria-hidden="true"></i></a></li>');
}
$totalPages=$admincrudpanel->Allproductswi();
for($i=1; $i <= $totalPages; $i++){
    if($_GET['id']==$i){
        echo('<li class="active"><a href="blog-list.php?id='.$i.'">'.$i.'</a></li>');
    }else{
        echo('<li><a href="blog-list.php?id='.$i.'">'.$i.'</a></li>');
    }
}
if($_GET['id']==$totalPages){
    ...
    echo('<li><a href="blog-list.php?id='.$next.'" class="arrow" title="Next"><i class="fas fa-angle-double-right" aria-hidden="true"></i></a></li>');
}
?>
                ...
                <div class="col-lg-4">
                    <div class="sidebar">
                        ...
                        <div class="sidebar-box tags wow left-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                            <h3 class="h3-title">Mots clés</h3>
                            <ul>
