            ...
            <div class="row">
                <div class="col-12">
                    <div class="interior-exterior-tabbing wow fadeup-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                          ...
                          <?php
                                $allpiece = $admincrudpanel->getexactcar($_GET['id_vehicule']);
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="car-detail-content wow right-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        ...
                        <h3 class="h3-title">TND <?php echo($singlepiece['prix']);?> </h3>
                    ...
                    <div class="book-car-box wow left-animation" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <p id="errur"></p>
                                <div class="car-form-box">
                                    <div class="form-box">
                                         <a href="panier.php?id_vehicule=<?php echo($_GET['id_vehicule']);?>" class="sec-btn" title="Ajouter Au Panier"><span>Ajouter Au Panier</span></a>
                                    </div>
                                </div>
                            </div>
                    </div>
