...
if($admincrudpanel->categoxistS($_GET['id'])=='LEE!'){
    header("Location: categories.php");
}

$marto='';
if(isset($_POST['submit'])){
	$ok=$admincrudpanel->editcatego($_GET['id'],$_POST['catego']);
    $marto='<div class="sufee-alert alert with-close alert-success alert-dismissible fade show"><span class="badge badge-pill badge-success">Succès</span>Vous avez réussi à mettre à jour les détails de la categorie.<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';
}
...
<head>
    ...
    <!-- Title Page-->
    <title><?php echo($ta3b['sitename']);?> - Mettre à jour les détails de la catégorie</title>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="active has-sub">
                            <a href="categories.php">
                                <i class="fas fa-plus-circle"></i>Les catégories Pour les voitures</a>
                        </li>
                        <li>
                            <a href="commande.php">
                        ...
                        <li>
                            <a href="setting.php">
                                <i class="fas fa-solid fa-gear"></i>Settings</a>
                        </li>
                        <!---------------------------------------->
                    </ul>
                </div>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="setting.php">
                                <i class="fas fa-solid fa-gear"></i>Réglages</a>
                        </li>
                        <!---------------------------------------->
                    </ul>
                </nav>
                    ...
                    <div class="container-fluid">
                                <div class="card">
                                        ...
                                        <form id="form1" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <?php 
                                                        $l = $admincrudpanel->categist($_GET['id']);
                                                        foreach ($l as $singcate) {
                                                    ?>
                                                        <input type="text" id="catego" name="catego" value="<?php echo($singcate['lista']);?>" placeholder="Text" class="form-control">
                                                    <?php
                                                        }
                                                    ?>
                                                </div>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <button type="button" onclick="checkvari();" class="btn btn-primary btn-sm"><i class="fa fa-dot-circle-o"></i> sauvegarder</button>
