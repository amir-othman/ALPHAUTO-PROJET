...
if(isset($_GET['done'])){
        $resulat='<div class="sufee-alert alert with-close alert-success alert-dismissible fade show"><span class="badge badge-pill badge-success">Succès</span>Vous avez supprimé le piece avec succès<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';
}
...
<head>
    ...
    <!-- Title Page-->
    <title><?php echo($ta3b['sitename']);?> - Liste des Pieces De Rechange</title>
    <!-- Fontfaces CSS-->
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <h3 class="title-5 m-b-35">Liste de vos Pieces De Rechange</h3>
                                    </div>
                                    <div class="table-data__tool-right">
                                        <button onclick="location.href='addpiece.php';" class="au-btn au-btn-icon au-btn--green au-btn--small"><i class="zmdi zmdi-plus"></i>Ajouter une piece</button>
                                        <button onclick="location.href='export.php?type=piece';" class="au-btn au-btn-icon au-btn--green au-btn--small" style="background: #555;"><i class="zmdi zmdi-plus"></i>Exporter en pdf</button>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive table--no-card m-b-30" >
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <?php 
                                                $admincrudpanel = new admincrudpanel();
                                                $listcars = $admincrudpanel->Allpiecepanel();
                                                foreach ($listcars as $singlepiece) {
                                            ?>
                                            <tr class="tr-shadow">
                                                <td><?php echo($singlepiece['nompiece']);?></td>
                                                <td><?php $n=$singlepiece["img"];echo("<img src='../view/".$n."' width='50' >");?></td>
                                                <td><?php echo($singlepiece['prixpiece']." TND");?></td>
                                                <td><?php echo($singlepiece['poidspiece']);?></td>
                                                <td><?php echo($singlepiece['pays']);?></td>
                                                <td><?php echo($singlepiece['etatp']);?></td>
                                                <td>
                                                    <?php 
                                                        $typeofcar = $admincrudpanel->getsingletypepiece($singlepiece['category']);
                                                ...
                                                <td>
                                                 <div class="table-data-feature">
                                                    <button class="item" data-toggle="tooltip" onclick="location.href='editpiece.php?id=<?php echo($singlepiece['idp']);?>';" data-placement="top" title="Éditer"><i class="zmdi zmdi-edit"></i></button>
                                                    <button class="item" data-toggle="tooltip" onclick="location.href='delete.php?type=piece&id=<?php echo($singlepiece['idp']);?>';" data-placement="top" title="Effacer"><i class="zmdi zmdi-delete"></i></button>
                                                  </div>
                                                </td>
                                            </tr>
                                            <tr class="spacer"></tr>
