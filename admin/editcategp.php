...
if(!isset($_GET['id'])){
    header("Location: categoriesp.php");
}
if($admincrudpanel->categpxist($_GET['id'])=='LEE!'){
    header("Location: categoriesp.php");
}

$marto='';
if(isset($_POST['submit'])){
	$ok=$admincrudpanel->editcategop($_GET['id'],$_POST['catego']);
                                        ...
                                        <form id="form1" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <?php 
                                                        $l = $admincrudpanel->categistp($_GET['id']);
                                                        foreach ($l as $singcate) {
                                                    ?>
                                                        <input type="text" id="catego" name="catego" value="<?php echo($singcate['nom_cat']);?>" placeholder="Text" class="form-control">
                                                    <?php
                                                        }
                                                    ?>
                                                </div>
