                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <h3 class="title-5 m-b-35">Liste de vos voitures à vendre</h3>
                                    </div>
                                    <div class="table-data__tool-right">
                                        ...
                                        <button onclick="location.href='export.php?type=sell';" class="au-btn au-btn-icon au-btn--green au-btn--small" style="background: #555;"><i class="zmdi zmdi-plus"></i>Exporter en pdf</button>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive table--no-card m-b-30" >
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <?php 
                                                $admincrudpanel = new admincrudpanel();
                                                $listcars = $admincrudpanel->getAllitems();
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                 <div class="table-data-feature">
                                                    <button class="item" data-toggle="tooltip" onclick="location.href='editcar.php?id=<?php echo($row['idVehicule']);?>';" data-placement="top" title="Éditer"><i class="zmdi zmdi-edit"></i></button>
                                                    <button class="item" data-toggle="tooltip" onclick="location.href='delete.php?type=carsv&id=<?php echo($row['idVehicule']);?>';" data-placement="top" title="Effacer"><i class="zmdi zmdi-delete"></i></button>
                                                  </div>
                                                </td>
                                            </tr>
                                            <tr class="spacer"></tr>
