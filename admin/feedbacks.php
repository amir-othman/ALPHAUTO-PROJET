							...
							<div class="col-lg-13">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-02.jpg');">
                                        ...
                                        <h3><i class="zmdi zmdi-comment-text"></i>Tous les messages</h3>
                                    ...
                                    <div class="au-inbox-wrap js-inbox-wrap">
                                        <div class="au-message js-list-load">
                                            <div class="au-message__noti">
                                                <?php $total = $admincrudpanel->getunreadfeedback();?>
                                                <p>Vous avez<span> <?php echo($total);?> </span> messages</p>
                                            </div>
                                            <div class="au-message-list">
                                            <?php 
                                                $allfeedbacks = $admincrudpanel->getfeedback($_SESSION['smartCookies']);
                                                foreach ($allfeedbacks as $singlefeed) {
                                            ?>
                                                <div class="au-message__item" onclick='window.location = "readfeed.php?id=<?php echo($singlefeed['id']);?>"'> 
                                                    <div class="au-message__item-inner">
                                                        <div class="au-message__item-text">
                                                            ...
                                                            <div class="text">
                                                                <h5 class="name"><?php echo($singlefeed['firstname']." ".$singlefeed['lastname']);?></h5>
                                                                <?php 
                                                                    $dourepl = $admincrudpanel->didireplytofeed($singlefeed['id']);
                                                                    if($dourepl->rowCount()!=0){
                                                                        $lastmsg = $admincrudpanel->getmylastreply($singlefeed['id']);
                                                                        foreach ($lastmsg as $lstrepl){
                                                                            $monrep=$lstrepl['reply'];
                                                                            echo('<p><b>Toi</b> : '.$monrep.'</p>');
                                                                        }
                                                                    }else{
                                                                ?>
                                                                <p><?php echo($singlefeed['message']);?></p>
                                                            <?php }?>
                                                            </div>
                                                        </div>
                                                    </div>
