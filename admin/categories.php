                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <h3 class="title-5 m-b-35">Liste de vos catégories de voitures</h3>
                                    </div>
                                    <div class="table-data__tool-right">
                                        <button onclick="location.href='addcate.php';" class="au-btn au-btn-icon au-btn--green au-btn--small"><i class="zmdi zmdi-plus"></i>ajouter une catégorie</button>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive table--no-card m-b-30" >
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <?php 
                                                $admincrudpanel = new admincrudpanel();
                                                $listcars = $admincrudpanel->getlistcateg();
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                 <div class="table-data-feature">
                                                    <button class="item" data-toggle="tooltip" onclick="location.href='editcatego.php?id=<?php echo($row['id']);?>';" data-placement="top" title="Edit"><i class="zmdi zmdi-edit"></i></button>
                                                    <button class="item" data-toggle="tooltip" onclick="location.href='delete.php?type=cate&id=<?php echo($row['id']);?>';" data-placement="top" title="Delete"><i class="zmdi zmdi-delete"></i></button>
                                                  </div>
                                                </td>
                                            </tr>
                                            <tr class="spacer"></tr>
