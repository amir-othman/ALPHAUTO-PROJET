...
if(isset($_GET['done'])){
        $resulat='<div class="sufee-alert alert with-close alert-success alert-dismissible fade show"><span class="badge badge-pill badge-success">Succès</span>Vous avez supprimé le categorie avec succès<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';
}
...
<head>
    ...
    <!-- Title Page-->
    <title><?php echo($ta3b['sitename']);?> - Liste des categories Voitures</title>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <button onclick="location.href='addcatep.php';" class="au-btn au-btn-icon au-btn--green au-btn--small"><i class="zmdi zmdi-plus"></i>ajouter une catégorie</button>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive table--no-card m-b-30" >
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <?php 
                                                $admincrudpanel = new admincrudpanel();
                                                $listcars = $admincrudpanel->getlistcategp();
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                 <div class="table-data-feature">
                                                    <button class="item" data-toggle="tooltip" onclick="location.href='editcategp.php?id=<?php echo($row['idCategory']);?>';" data-placement="top" title="Edit"><i class="zmdi zmdi-edit"></i></button>
                                                    <button class="item" data-toggle="tooltip" onclick="location.href='delete.php?type=catep&id=<?php echo($row['idCategory']);?>';" data-placement="top" title="Delete"><i class="zmdi zmdi-delete"></i></button>
                                                  </div>
                                                </td>
                                            </tr>
                                            <tr class="spacer"></tr>
