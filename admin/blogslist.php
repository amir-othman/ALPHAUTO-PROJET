...
if(isset($_GET['done'])){
        $resulat='<div class="sufee-alert alert with-close alert-success alert-dismissible fade show"><span class="badge badge-pill badge-success">Success</span>You successfully deleted the cars<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';
}
...
<head>
    ...
    <!-- Title Page-->
    <title><?php echo($sitename);?> - Panneau des blogs</title>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <h3 class="title-5 m-b-35">Liste de vos blogs</h3>
                                    </div>
                                    <div class="table-data__tool-right">
                                        <button onclick="location.href='addblog.php';" class="au-btn au-btn-icon au-btn--green au-btn--small"><i class="zmdi zmdi-plus"></i>Ajouter un blog</button>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive table--no-card m-b-30" >
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <?php 
                                                $listcars = $admincrudpanel->Allproducts();
                                                foreach ($listcars as $row) {
                                            ?>
                                            <tr class="tr-shadow">
                                                <td><?php echo($row['title']);?></td>
                                                <td><?php echo('<img src=../view/'. $row['img'].' width="50" >');?></td>
                                                <td><?php echo($row['description']);?></td>
                                                <td><?php echo($row['datep']);?></td>
                                                <td>
                                                 <div class="table-data-feature">
                                                    <button class="item" data-toggle="tooltip" onclick="location.href='editblog.php?id=<?php echo($row['id']);?>';" data-placement="top" title="Edit"><i class="zmdi zmdi-edit"></i></button>
                                                    <button class="item" data-toggle="tooltip" onclick="location.href='delete.php?type=blog&id=<?php echo($row['id']);?>';" data-placement="top" title="Delete"><i class="zmdi zmdi-delete"></i></button>
                                                  </div>
                                                </td>
                                            </tr>
                                            <tr class="spacer"></tr>
