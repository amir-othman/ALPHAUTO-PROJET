...
$list = $admincrudpanel->getAllPanier();
...
<head>
    ...
    <!-- Title Page-->
    <title><?php echo($ta3b['sitename']);?> - Liste des commandes</title>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                             ...
                             <th><?= $item->id; ?></th>
                                        ...
                                        <th> <a href="commande_details.php?id_commande=<?= $item->id; ?>">Consulter</a> </th>
                            </tr>
                            <?php endforeach ?>
                                </tbody>
                                    </table>
