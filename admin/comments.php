...
<head>
    ...
    <!-- Title Page-->
    <title><?php echo($ta3b['sitename']);?> - Liste de Commentaires</title>
    <!-- Fontfaces CSS-->
                            ...
                            <div class="col-lg-13">
                                ...
                                <div class="user-data m-b-30">
                                    ...
                                    <h3 class="title-3 m-b-30">
                                        <i class="zmdi zmdi-account-calendar"></i>Tous les commentaires</h3>
                                    <div class="table-responsive table-data">
                                        <table class="table">
                                            ...
                                            <tbody>
                                            	<?php 
                                            		$allcomments = $admincrudpanel->getpanelcomments();
                                            		foreach ($allcomments as $signcomment) {
                                            	?>
                                                <tr>
                                                    <td>
                                                        <div class="table-data__info">
                                                            <h6><?php echo($signcomment['firstname']." ".$signcomment['lastname']);?></h6>
                                                            <span>
                                                                <a href="#"><?php echo($signcomment['email']);?></a>
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    	<?php 
                                                    		$shof=$admincrudpanel->getusertype($signcomment['email']);
                                                    		if($shof=="NOTUSER!"){
                                                    			echo('<span class="role admin">Visiteur</span>');
                                                    		}else if($shof=="USER!"){
                                                    			echo('<span class="role member">membre</span>');
                                                    		}else if($shof=="ADMIN!"){
                                                    			echo('<span class="role user">ADMIN</span>');
                                                    		}else{
                                                    			echo('<span class="role user">ERROR</span>');
                                                    		}
                                                    	?>
                                                    ...
                                                    <td>
                                                        <div class="table-data__info">
                                                            <span>
                                                                <?php echo($signcomment['message']);?>
                                                            </span>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    	 
                                                    <button class="item" data-toggle="tooltip" onclick="location.href='../view/blog-detail.php?id=<?php echo($signcomment['blogid']);?>'" data-placement="top" title="voir le blog"><i class="fas fa-eye"></i></button>  &nbsp; &nbsp; 
                                                    <button class="item" data-toggle="tooltip" onclick="location.href='delete.php?type=comment&id=<?php echo($signcomment['id']);?>';" data-placement="top" title="Effacer le Commentaire"><i class="zmdi zmdi-delete"></i></button>
