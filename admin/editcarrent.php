...
if(!isset($_GET['id'])){
	header("Location: carslistr.php");
}
if($admincrudpanel->carexistR($_GET['id'])=='LEE!'){
	header("Location: carslistr.php");
}
$marto='';
if(isset($_POST['submit'])){
    ...
    $ok=$admincrudpanel->upditemrent($picupload,$_POST['brand'],$_POST['modele'],$_POST['prix'],$_POST['reviews'],$_POST['nbp'],$_POST['clima'],$_POST['vitesse'],$_POST['carburant'],$_POST['catego'],$_GET['id']);
    if($ok=="OK!"){
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form id="form1" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <?php 
                                            	$l = $admincrudpanel->getexactcarrent($_GET['id']);
