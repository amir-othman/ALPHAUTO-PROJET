                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-left">
                                        <h3 class="title-5 m-b-35">Liste de vos Commandes pour location</h3>
                                    </div>
                                </div>
                                ...
                                <div class="table-responsive table--no-card m-b-30" >
                                    <table class="table table-data2">
                                        ...
                                        <tbody>
                                            <?php 
                                                $admincrudpanel = new admincrudpanel();
                                                $listcars = $admincrudpanel->Alllocationpanel();
                                                foreach ($listcars as $singlepiece) {
                                            ?>
                                            <tr class="tr-shadow">
                                                <td><?php echo($singlepiece['fullname']);?></td>
                                                <td><?php echo($singlepiece['phonenumber']);?></td>
                                                <td><?php echo($singlepiece['email']);?></td>
                                                <td><?php echo("<a href='../view/car-detail.php?id_vehicule=".$singlepiece['carid']."'>Click Here</a>");?></td>
                                                <td><?php echo($singlepiece['debut']);?></td>
                                                <td><?php echo($singlepiece['fin']);?></td>
                                                <td><?php echo($singlepiece['prix']);?></td>
                                                <td>
                                                 <div class="table-data-feature">
                                                 	<?php 
                                                 		$rep = $admincrudpanel->didireply($singlepiece['id']);
                                                 		if($rep=="LEE!"){
                                                 	?>
                                                 		<button class="item" data-toggle="tooltip" onclick="location.href='delete.php?type=location&email=<?php echo($singlepiece['email'])?>&answer=ok&id=<?php echo($singlepiece['id']);?>';" data-placement="top" title="Accepter"><i class="zmdi zmdi-check"></i></button>

                                                 		<button class="item" data-toggle="tooltip" onclick="location.href='delete.php?type=location&email=<?php echo($singlepiece['email'])?>&answer=no&id=<?php echo($singlepiece['id']);?>';" data-placement="top" title="Refuser"><i class="zmdi zmdi-stop"></i></button>
                                                 	<?php
                                                 		}else{
                                                 			$rep = $admincrudpanel->getmyreply($singlepiece['id']);
                                                 			if ($rep=="ok") {
                                                 				echo('<span class="role member">Accepter</span>');
                                                 			}else{
                                                 				echo('<span class="role admin">refuser</span>');
                                                 			}
                                                 		}
                                                 	?>
                                                  </div>
